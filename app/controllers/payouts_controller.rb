class PayoutsController < ApplicationController
  ...
  # GET /payouts.json
  def index
    @payouts = Payout.all.order(:year, :round)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @payout.save
        flash[:success] = "Payout created successfully." 
        format.html { redirect_to @payout}
  ...
  private
    ...
    def payout_params
      params.require(:payout).permit(:game_payout, :round, :year)
    end
end
